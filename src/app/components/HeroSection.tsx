      ...
      >
        <div className="space-y-6">
          ...
          <div className="space-x-4 mt-6">
            <button className="bg-yellow-400 text-purple-900 px-6 py-3 rounded-full hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105">
              Book Now
            </button>
            <button className="text-white border border-white px-6 py-3 rounded-full hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105">
              Learn More
            </button>
          </div>
        </div>
